...
namespace FBReader.AppServices.ViewModels.Pages.Catalogs
{
    public class CopsPageViewModel : CatalogPageViewModel
    {
        ...
        public void NavigateToLanguages()
        {
            ...
            IsItemsState = true;
            FolderItems = null;
            treeReader.GoTo(new CatalogItemModel { OpdsUrl = "http://sopdsbook.ru:8081/?id=04" });
            LoadItems();
        }
        ...
        public void NavigateToAuthors()
        {
            ...
            IsItemsState = true;
            FolderItems = null;
            treeReader.GoTo(new CatalogItemModel { OpdsUrl = "http://sopdsbook.ru:8081/?id=02" });
            LoadItems();
        }
        ...
        public void NavigateToTags()
        {
            ...
            IsItemsState = true;
            FolderItems = null;
            treeReader.GoTo(new CatalogItemModel { OpdsUrl = "http://sopdsbook.ru:8081/?id=01" });
            LoadItems();
        }
        ...
        public void NavigateToNames()
        {
            ...
            IsItemsState = true;
            FolderItems = null;
            treeReader.GoTo(new CatalogItemModel { OpdsUrl = "http://sopdsbook.ru:8081/?id=06" });
            LoadItems();
        }
    }
}